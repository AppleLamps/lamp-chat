...
import SystemPromptsView from './systemPromptsView.js';
...
class SettingsView {
    ...
    initializeElements() {
        ...
        // Initialize System Prompts View
        this.initializeSystemPromptsView();
    }
    ...
    initializeSystemPromptsView() {
        // Initialize the system prompts view if the panel exists
        const systemPromptsPanel = document.getElementById('system-prompts-panel');
        if (systemPromptsPanel) {
            this.systemPromptsView = new SystemPromptsView();
        }
    }
    ...
    switchTab(selectedButton) {
        ...
        // If this is the system prompts tab, make sure the view is loaded
        if (targetId === 'system-prompts' && this.systemPromptsView) {
            this.systemPromptsView.loadSystemPrompts();
        }
    }
    ...
    handleUrlHash() {
        ...
        if (hash) {
            ...
            if (tabButton) {
                ...
                // If this is the system prompts tab, make sure the view is loaded
                if (targetTab === 'system-prompts' && this.systemPromptsView) {
                    console.log('Refreshing system prompts view');
                    this.systemPromptsView.loadSystemPrompts();
                }
            } else {
